...
PROCUREMENT_API_IS_LIVE = bool(
    _procurement_api_is_live_env and NEXAR_CLIENT_ID and NEXAR_CLIENT_SECRET
)
...
# Official stable Gemini API models (as of Jan 2026)
GEMINI_2_5_PRO = dspy.LM(
    "gemini/gemini-2.5-pro", api_key=GOOGLE_API_KEY
)  # 1M context, advanced thinking
GEMINI_2_5_FLASH = dspy.LM(
    "gemini/gemini-2.5-flash", api_key=GOOGLE_API_KEY
)  # 1M context, balanced
GEMINI_2_5_FLASH_LITE = dspy.LM(
    "gemini/gemini-2.5-flash-lite", api_key=GOOGLE_API_KEY
)  # 1M context, fastest, cheapest
GEMINI_3_PRO = dspy.LM(
    "gemini/gemini-3-pro-preview", api_key=GOOGLE_API_KEY
)  # Preview, most intelligent
GEMINI_3_FLASH = dspy.LM(
    "gemini/gemini-3-flash-preview", api_key=GOOGLE_API_KEY
)  # Preview, balanced
...
MODEL_OPTIONS = [
    {
        ...
        "name": "Gemini 2.5 Flash-Lite (Fastest, Cheapest)",
        "provider": "Google",
    },
    {
        "id": "gemini-2.5-flash",
    ...
    {
        "id": "gemini-3-pro",
        "name": "Gemini 3 Pro Preview (Most Intelligent)",
        "provider": "Google",
    },
]
