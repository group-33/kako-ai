...
def build_bom_tool_block(
    ...
    *,
    ...
    # Transform local temp path to served URL path for source document
    ...
    # Transform local temp path to served URL path for preview image
    ...
    bom_data = BOMTableData(rows=rows, source_document=source_document, preview_image=preview_image)
