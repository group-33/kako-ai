...
def build_bom_tool_block(
    ...
    *,
    ...
    if source_document and os.path.isabs(source_document):
        ...
        # Check if file is in temp dir (loosely, or just assume based on filename)
        # Safest: just take basename and point to /files if it looks like a file generated by us
