            ...
            <div className="max-w-6xl mx-auto space-y-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <button
                        ...
                        className="group relative overflow-hidden p-8 rounded-2xl bg-white border border-slate-200 shadow-sm hover:shadow-xl hover:border-slate-300 transition-all duration-300 text-left"
                    >
                        <div className="absolute top-0 right-0 p-3 opacity-10 group-hover:opacity-20 transition-opacity">
                            <UploadCloud size={120} className="text-slate-200 rotate-12 transform translate-x-4 -translate-y-4" />
                        </div>
                ...
                <div>
                    <div className="flex items-center justify-between mb-6">
                        ...
                        <button onClick={() => navigate('/chat')} className="text-blue-600 text-sm font-semibold hover:text-blue-700 transition-colors">
                        ...
                        {recentThreads.length > 0 ? (
                            recentThreads.map((thread) => (
                                <div
                                    ...
                                    className="flex items-center justify-between p-4 bg-white rounded-xl border border-slate-100 shadow-sm hover:shadow-md hover:border-slate-200 transition-all cursor-pointer group"
                                >
                                    <div className="flex items-center gap-4">
                                        <div className="w-10 h-10 rounded-full bg-slate-50 flex items-center justify-center border border-slate-100 group-hover:bg-white group-hover:border-slate-300 transition-colors">
                                            <Clock className="text-slate-400 group-hover:text-blue-600" size={18} />
                                        </div>
                                        <div>
                                            <h4 className="font-semibold text-slate-900 group-hover:text-blue-700 transition-colors">{thread.title}</h4>
